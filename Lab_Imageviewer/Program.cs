...
public class Program
{
	...
	private static void CreateScanner()
    {
        ...
        var path = Path.Combine(BASE_PATH, string.IsNullOrWhiteSpace(input) ? "images" : input);
	...
	private static void AdjustOutputPath()
	{
        ...
        var path = Path.Combine(BASE_PATH, string.IsNullOrWhiteSpace(input) ? "output" : input);
